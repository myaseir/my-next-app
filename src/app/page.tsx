...
import nameBottom from "/public/images/public/images/WhatsApp Image 2025-05-10 at 1.25.21 AM.jpeg";
            ...
            <div className="relative">
                ...
                <div className="flex flex-col items-center relative -mt-10 sm:-mt-16 mb-0">
                    <div className="image relative flex justify-center">
                        <Image className="animate-fade-up" src={bannerModel} alt="Model" height={800} />
                    </div>
            ...
            <div className="container mx-auto px-4 sm:px-10">
                <div className="grid grid-cols-12 gap-6 mt-10">
                    ...
                    <div data-aos="fade-left" className="col-span-12 lg:col-span-6 flex flex-col relative items-start justify-center">
                        ...
                        <div className="mt-3 w-full">
                            <label className="text-black inline-block mb-1"> Web Development</label>
                ...
                <div className="flex flex-col md:flex-row px-0 md:px-10 py-10">
                    <div data-aos="fade-right" className="w-full md:w-2/4 px-5 md:px-10 mb-10 md:mb-0">
                        ...
                        <div>
                            ...
                            <ProgressBar percentage={'98%'} width="w-[99%]"/>
                        </div>
                        <div>
                            <label className="inline-block mt-3 mb-1">CSS</label>
                            <ProgressBar percentage={'94%'} width="w-[98%]"/>
                        </div>
                        <div>
                    ...
                    <div data-aos="fade-left" className="w-full md:w-2/4 px-5 md:px-10">
                        ...
                        <div>
                            <label className="inline-block mt-3 mb-1">React.js</label>
                            <ProgressBar percentage={'80%'} width="w-[80%]"/>
                        </div>
                        <div>
                            <label className="inline-block mt-3 mb-1">Next.js</label>
        ...
        <section id="contact" className="contact py-20 px-4 md:px-20">
            <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-6">
                  ...
                  <ul data-aos="fade-up">
                        <li className="my-2"><a className="flex gap-4 items-center" href="tel:+923413975290"><HiPhone className="bg-orange-500 text-white text-sm w-10 h-10 p-2 rounded-full flex items-center justify-center"/>  +92 3413975290</a></li>
                        <li className="my-2"><a className="flex gap-4 items-center" href="mailto:yasserraahimi0351@gmail.com"><HiMail className="bg-orange-500 text-white text-sm w-10 h-10 p-2 rounded-full flex items-center justify-center"/> yasserraahimi0351@gmail.com</a></li>
                        <li className="my-2"><a className="flex gap-4 items-center" target="_blank" href="https://github.com/yasserraahiimi"> <FaGithub className="bg-orange-500 text-white text-sm w-10 h-10 p-2 rounded-full flex items-center justify-center"/> yasserraahiimi</a></li>
                    </ul>
                </div>
